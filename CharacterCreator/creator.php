  ...
  <section class="cc-glass cc-panel">
    <div class="d-flex align-items-start justify-content-between flex-wrap gap-3">
      ...
      <div class="cc-progress-pill" style="min-width: min(520px, 100%);">
        ...
        <div class="cc-bar" aria-label="Progress"><div id="progressBar"></div></div>
      </div>
    </div>
    ...
    <div class="cc-wizard">
      <aside class="cc-steps" aria-label="Steps">
        <button class="cc-step-btn active" type="button" data-step="1"><span class="cc-step-num">1</span><span><div class="cc-step-title">Basics</div><div class="cc-step-desc">Identity & class</div></span></button>
        <button class="cc-step-btn" type="button" data-step="2"><span class="cc-step-num">2</span><span><div class="cc-step-title">Traits</div><div class="cc-step-desc">(+2,+1,+1,0,0,-1)</div></span></button>
        <button class="cc-step-btn" type="button" data-step="3"><span class="cc-step-num">3</span><span><div class="cc-step-title">Defense</div><div class="cc-step-desc">Armor, thresholds, HP</div></span></button>
        <button class="cc-step-btn" type="button" data-step="4"><span class="cc-step-num">4</span><span><div class="cc-step-title">Experience</div><div class="cc-step-desc">List</div></span></button>
        <button class="cc-step-btn" type="button" data-step="5"><span class="cc-step-num">5</span><span><div class="cc-step-title">Gear</div><div class="cc-step-desc">Weapons + Inventory</div></span></button>
        <button class="cc-step-btn" type="button" data-step="6"><span class="cc-step-num">6</span><span><div class="cc-step-title">Review</div><div class="cc-step-desc">Validate</div></span></button>
      </aside>
      ...
      <section class="cc-sheet" aria-label="Step content">
        ...
        <?php include __DIR__ . '/partials/step6_review.php'; ?>
