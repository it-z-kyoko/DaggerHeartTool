...
<body>
    ...
    <script>
        ...
        function rowMeta(fearVal) {
            // fear: 0 => hope (gold), 1 => fear (blue), null => neutral
            if (fearVal === 0) return {
                rowClass: 'roll-hope',
                badgeClass: 'badge-hope',
                label: 'HOPE'
            };
            if (fearVal === 1) return {
                rowClass: 'roll-fear',
                badgeClass: 'badge-fear',
                label: 'FEAR'
            };
            return {
                rowClass: 'roll-neutral',
      ...
      `;
        ...
        async function refreshRolls() {
            ...
            try {
                ...
                // Only re-render if something changed (saves DOM work + feels calmer)
